...
const RX = {
  ...
  science: /\b(scientists?|researchers?|study|discover(y|ed|s)?|fossils?|species|dinosaurs?|archaeolog\w*|ancient|climate change|global warming|artificial intelligence|AI|quantum|vaccines?|breakthrough|genome|physics|robot\w*|health|flu|disease|virus|cancer|medical|hospitals?|doctors|patients|algae|algal bloom|conservation|environment\w*|pollution|emissions|endangered)\b/gi,
  politics: /\b(elections?|electoral|vote[sd]?|voters|voting|polls?|parliament\w*|president\w*|prime minister|premier|senate|senators?|congress\w*|governor|legislature|lawmakers|legislation|minister|cabinet|campaign|ballot|referendum|supreme court|court|judge|impeach\w*|opposition|protests?|protesters|White House|Trump|Republicans?|Democrats?|GOP|diplomat\w*|summit|treaty|immigration|deport\w*|shutdown|policy|talks|negotiat\w*|alliance|EU|far right|far-right|midterms?|mayor|parties|party|government|laws?|bills?|foreign minister|ambassadors?|embass(y|ies)|State Department|urges|stance|detention|detained|asylum|migrants?|refugees?|vouchers?|school board|open records|public records|PM|spy chief|intelligence|schools?|independence)\b/gi,
  business: /\b(economy|economic|inflation|recession|GDP|stocks?|markets?|Wall Street|Dow|Nasdaq|tariffs?|trade deal|trade war|central bank|interest rates?|Federal Reserve|jobs report|unemployment|layoffs|merger|acquisition|IPO|earnings|revenue|billion|startup|oil prices|OPEC|crypto\w*|bitcoin|CEO|Nvidia|Apple|Tesla|prices?|investors?|investments?|banks?|banking|shareholders?|shareholdings?|stake|trade pact|free trade|trade agreement|exports?|imports?|fiscal|budget|debt|bonds?|currenc(y|ies)|oil|fuel|energy|mining|cocoa|coffee|commodit(y|ies)|airlines?|retail\w*|companies|company|firms?|profits?|sales|shares|bankrupt\w*|deals?|spin-offs?|automakers?|manufactur\w*)\b/gi,
  crime: /\b(police|officers?|shooting|shootings|shot|gunman|gunfire|murder\w*|homicide|stabb\w*|arrest\w*|charged|suspects?|trial|guilty|convicted|sentenced|prison|jail\w*|robbery|arson|kidnap\w*|fraud|smuggl\w*|cartels?|gangs?|detectives|manhunt|inmates?|indicted|prosecutors?)\b/gi,
  culture: /\b(festival|film|movie|box office|music|concert|tour|album|song|singer|rapper|museum|exhibition|art|artist|fashion|celebrity|Emmys?|Oscars?|Grammys?|awards?|book|novel|author|heritage|UNESCO|royal|King Charles|pope|Vatican|tourism|tourists|restaurant|chef|Broadway|Netflix|anniversary|celebrat\w*|parade|zoo|wildlife|whale|panda|auction|Michelin|holidays?|travel|hike|hiking|wine|food|actor|actress|television|TV series|theat(re|er)|ballet|opera|architecture|design|film\w*|documentar(y|ies)|dies at \d+|trips?)\b/gi,
};
const ORDER = ['sports', 'disaster', 'conflict', 'space', 'science', 'politics', 'business', 'crime', 'culture'];
const WEIGHT = { sports: 1, disaster: 1.6, conflict: 1.4, space: 2, science: 1.1, politics: 1, business: 0.9, crime: 1, culture: 0.9 };
...
export function classify(titles, doms, hints) {
  ...
  let best = 'general', bestScore = 0.85; // one business/culture keyword (weight 0.9) is enough
...
// Templated game previews, box scores and live blogs: fine for fans, noise on a world news map.
export const SPORTS_FILLER = /\b(takes on|looks to|seeks \d+\w* win|box score|kickoff time|first look at|live updates|how to watch|odds|predictions?|picks|injury report|depth chart|player grades|takeaways)\b/i;
